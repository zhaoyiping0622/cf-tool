...
[![Github release](https://img.shields.io/github/release/zhaoyiping0622/cf-tool.svg)](https://cf/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://cf/releases)
[![Build Status](https://travis-ci.org/zhaoyiping0622/cf-tool.svg?branch=master)](https://travis-ci.org/zhaoyiping0622/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/cf)](https://goreportcard.com/report/cf)
...
You can download the pre-compiled binary file in [here](https://cf/releases).
 ...
 * You can download the binary file in here https://cf (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
